                    ...
                    <div className="flex space-x-2">
                        <div className="grid grid-cols-1 w-1/3 gap-3">
                            {menu?.map((item) => (
                                <Link
                                    key={item.id}
                                    className="space-y-3 flex place-content-center place-items-center text-center relative bg-white border border-gray-300 rounded-lg px-3 py-2 shadow-lg hover:shadow-xl transform hover:scale-105 transition-transform duration-300"
                                    to={item.route}
                                >
                                    <div>
