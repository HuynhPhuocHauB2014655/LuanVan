            ...
            <div className="main-content ">
                ...
                <div className="right-part relative">
                    ...
                    <div className="px-3">
                        ...
                        <table className="w-full table md:text-xl px-3">
                            <thead>
                            ...
                            <tbody>
                                {datas && datas.map((data, index) => (
                                    <tr key={index} className="">
                                        <td className={`p-4 ${index % 2 !== 0 && "bg-slate-200"}`}>{data.MaMH}</td>
                                        <td className={`p-4 ${index % 2 !== 0 && "bg-slate-200"}`}>{data.TenMH}</td>
                                        <td className={`p-4 ${index % 2 !== 0 && "bg-slate-200"}`}>
                                            <div className="flex justify-center">
                                                <button className="px-2 py-1 border hover:bg-sky-300 rounded bg-white border-black hover:border-sky-500" onClick={() => showFormSubject(2, data)}>Sửa</button>
                                                <button type="button" className="ms-1 px-2 py-1 border hover:bg-red-300 rounded bg-white border-black hover:border-red-500" onClick={() => deleteSubject(data.MaMH)}>
                                                    Xóa
                                                </button>
                                            </div>
                                        </td>
