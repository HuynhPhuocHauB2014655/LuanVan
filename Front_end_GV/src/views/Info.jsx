                    ...
                    <table className="w-[70%] text-center border-collapse">
                        <tbody>
                            <tr className="border-b border-slate-400">
                                <td className="py-2 font-semibold text-gray-700">Mã giáo viên</td>
                                <td className="py-2 text-gray-900">{info.MSGV}</td>
                            </tr>
                            <tr className="border-b border-slate-400">
                                <td className="py-2 font-semibold text-gray-700">Họ và tên</td>
                                <td className="py-2 text-gray-900">{info.TenGV}</td>
                            </tr>
                            <tr className="border-b border-slate-400">
                            ...
                            <tr className="border-b border-slate-400">
                                <td className="py-2 font-semibold text-gray-700">Chuyên môn</td>
                                <td className="py-2 text-gray-900">{info.mon_hoc?.TenMH || "Chưa có chuyên môn"}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
